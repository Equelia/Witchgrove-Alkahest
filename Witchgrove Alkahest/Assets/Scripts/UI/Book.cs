...
{
	[Header("UI Elements"), Tooltip("Assign UI elements for the book")] 
	...
	[Space(10f), Tooltip("Assign content of the book")] 
	[SerializeField] private Sprite[] bookPages;

	[Header("Settings")] [SerializeField] private bool interactable = true;
	[SerializeField] private bool enableShadowEffect = true;
	public int currentPage = 0;

	[Header("Image elements"), Tooltip("Assign Image Elements for the Book")]
	...
	[Space(10f)] public UnityEvent OnFlip;
	...
	{
		nextPageButton.interactable = currentPage < bookPages.Length - 2 && !pageDragging;
		previousPageButton.interactable = currentPage > 1 && !pageDragging;
	}
