...
public class FirstPersonController : MonoBehaviour
{
	...
	[Header("Jump/Land Shake Settings")] [SerializeField]
	...
	public void SetMouseSensitivity(float value)
	{
		...
		if (cCam != null)
		{
			cCam.Controllers[0].Input.LegacyGain = 100f * mouseSensitivity;
			cCam.Controllers[1].Input.LegacyGain = -100f * mouseSensitivity;
		}
